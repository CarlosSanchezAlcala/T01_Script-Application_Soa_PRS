...
('081108', 'CUSCO', 'PAUCARTAMBO', 'SAN FRANCISCO'),
...
VALUES
('Jesús Nolberto'		, 'Mayas'		, 'Campos'		, '52630214'	, '963032147' 	, 'Calle Simon Bolivar 874'		, 'NolbertoMayas@gmail.com'		,'150512'),
('Mario Alberto'		, 'Quispe'		, 'Tantaira'	, '45259632'	, '963023145'	, 'Av. Campos Campos 784'		, 'QuispeTantaira@hotmail.com'	,'150515'),
('Jesús Jacinto'		, 'Campos'		, 'Sanchez'		, '52630214'	, '985645147'	, 'Jr. Yañez Pozo Mz B Lote 12'	, 'AlmasAlmeida@outlook.com'	,'150502'),
('Maria Albertina'		, 'Almas'		, 'Almeida'		, '63524874'	, '963699999'	, 'Av. Las poles 56'			, 'AlbertinaAlmas@gmail.com'	,'150514'),
('Mauricio Carlos'		, 'Yañez'		, 'Alcala'		, '02120004'	, '985478745'	, 'Calle 145, Campos Yats'		, 'MauricioCarlos@gmail.com'	,'150502')
;
...
('Juan'					, 'García'		, 'Pérez'		, '12345678'	, '987654321'	,'Ayudante'		, 'N'			, 'Calle 123, Urbanización Los Pinos'	, 'juangp@gmail.com'				,'150405'),
('María'				, 'López'		, 'Martínez'	, '87654321'	, '923456789'	,'Guía'			, 'N'			, 'Avenida Central 45'					, 'marialm@hotmail.com'				,'150516'),
('Pedro'				, 'Fernández'	, 'Gómez'		, '23456789'	, '967890123'	,'Ayudante'		, 'N'			, 'Calle Mayor 67'						, 'pedrofg@outlook.com'				,'150516'),
('Ana'					, 'Sánchez'		, 'Rodríguez'	, '34567890'	, '978901234'	,'Guía'			, 'N'			, 'Paseo de la Playa 12'				, 'anasmr@gmail.com'				,'150516'),
('Carlos'				, 'Ramírez'		, 'Hernández'	, '45678901'	, '989012345'	,'Guía'			, 'N'			, 'Callejón 56'							, 'carlosrh@hotmail.com'			,'150405'),
('Sofía'				, 'Díaz'		, 'Pérez'		, '56789012'	, '990123456'	,'Guía'			, 'N'			, 'Camino Real 34'						, 'sofiadp@outlook.com'				,'150512'),
('Luis'					, 'Martínez'	, 'López'		, '67890123'	, '901234567'	,'Doctora'		, 'S'			, 'Ruta Verde 23'						, 'luismml@gmail.com'				,'150512'),
('Elena'				, 'Gómez'		, 'Fernández'	, '78901234'	, '912345678'	,'Doctora'		, 'S'			, 'Avenida Principal 78'				, 'elenagf@hotmail.com'				,'150405'),
('Miguel'				, 'Hernández'	, 'Sánchez'		, '89012345'	, '923456789'	,'Ayudante'		, 'N'			, 'Calle Mayor 67'						, 'miguelhs@gmail.com'				,'150512'),
('Isabel'				, 'Pérez'		, 'García'		, '90123456'	, '934567890'	,'Directora'	, 'S'			, 'Calle Nueva 56'						, 'isabelpg@outlook.com'			,'150405'),
('David'				, 'López'		, 'Díaz'		, '01234567'	, '945678901'	,'Ayudante'		, 'N'			, 'Avenida Principal 34'				, 'davidld@gmail.com'				,'150113'),
('Laura'				, 'Rodríguez'	, 'Ramírez'		, '12345670'	, '956789012'	,'Ayudante'		, 'N'			, 'Calle Real 89'						, 'laurarr@outlook.com'				,'150405'),
('Javier'				, 'Fernández'	, 'Martínez'	, '23456789'	, '967890123'	,'Directora'	, 'N'			, 'Paseo del Bosque 12'					, 'javierfm@gmail.com'				,'150509'),
('Sara'					, 'Gómez'		, 'Sánchez'		, '34567890'	, '978901234'	,'Doctora'		, 'S'			, 'Avenida del Parque 56'				, 'sarags@hotmail.com'				,'150405'),
('Carlos'				, 'Sánchez'		, 'López'		, '45678901'	, '989012345'	,'Ayudante'		, 'N'			, 'Callejón 78'							, 'carlossl@outlook.com'			,'150138'),
('María'				, 'Ramírez'		, 'Gómez'		, '56789012'	, '990123456'	,'Guía'			, 'N'			, 'Calle del Sol 23'					, 'mariarg@gmail.com'				,'150113'),
('Luis'					, 'Pérez'		, 'Hernández'	, '67890123'	, '901234567'	,'Ayudante'		, 'N'			, 'Avenida Central 67'					, 'luisph@hotmail.com'				,'150405'),
('Elena'				, 'López'		, 'Fernández'	, '78901234'	, '912345678'	,'Directora'	, 'N'			, 'Calle del Bosque 45'					, 'elenalf@outlook.com'				,'150138'),
('Javier'				, 'Sánchez'		, 'Díaz'		, '89012345'	, '923456789'	,'Directora'	, 'N'			, 'Paseo de la Playa 78'				, 'javiersd@gmail.com'				,'150138'),
('Sofía'				, 'Martínez'	, 'Pérez'		, '90123456'	, '934567890'	,'Directora'	, 'N'			, 'Calle Mayor 56'						, 'sofiaml@hotmail.com'				,'150511'),
('Esther'				, 'Dios'		, 'Yacila'		, '96354874'	, '985478478'	,'Doctora'		, 'S'			, 'Calle San Simon 48'					, 'YacilaDios@hotmail.com'			,'150511')
;

-- RECORDING DATA IN THE TABLE "OPERATIVE UNIT"

INSERT INTO operative_unit
(name				, id_funcionary		, phonenumber	, address)
VALUES
('SOA Arequipa'		, '1'				, '----------'	, 'Estadio Víctor Andrés Belaunde, sector  "Zamácola" - Cerro Colorado'),
('SOA Callao'		, '2'				, '----------'	, 'Av. Dos de Mayo Cdra.5 s/n. Corte Superior de Justicia del Callao'),
('SOA Cañete'		, '3'				, '01-4101010'	, 'Carretera Panamericana Sur Km. 144.5 - San Vicente de Cañete'),
('SOA Chiclayo'		, '4'				, '----------'	, 'Calle: Alfonso Ugarte 1378'),
('SOA Chimbote'		, '5'				, '----------'	, 'Ex Palacion Municipal s/n Plaza Mayor de Nuevo Chimbote'),
('SOA Huancavelica'	, '6'				, '----------'	, 'Jr. Torre Tagle y Nicolás de Piérola Corte Superior de Justicia de Huancavelica'),
('SOA Huancayo'		, '7'				, '----------'	, 'Calle Lima N° 415 - Huancayo'),
('SOA Huánuco'		, '8'				, '062-513449'	, 'Calle Los Nogales Mz "L" Lt 11 5to piso. Urb. Los Portales - Amarilis'),
('SOA Huaura'		, '9'				, '----------'	, 'Av. La Paz N°340 - 4to piso - Huacho Huaura'),
('SOA Ica'			, '10'				, '----------'	, 'Calle Londres cruce con Av. San Salvador - La Tinguiña (Parque Las Malvinas)'),
('SOA Iquitos'		, '11'				, '065-223513'	, 'Calle Samanez Ocampo N° 637'),
('SOA Lima Este'	, '12'				, '----------'	, 'Las Manzanas Mz “X”, Lt.16 - Urb.Ceres II Etapa - Ate'),
('SOA Lima Norte'	, '13'				, '----------'	, 'Municipalidad de Independencia'),
('SOA Rimac'		, '14'				, '01-4824041'	, 'Calle Reforma N° 187 - Rímac / Lima'),
('SOA Sullana'		, '15'				, '----------'	, 'Calle: María Auxiliadora N° 103'),
('SOA Trujillo'		, '16'				, '----------'	, 'Jr. Pumacahua N° 1027 - El Porvenir'),
('SOA Tumbes'		, '17'				, '072-508708'	, 'Jr. Bolognesi N° 194 - Municipalidad de Tumbes - Centro Cívico 3er piso.')
;
...
VALUES
('Jose Feliciano'		, 'Alcala'		, 'Sanchez'		, '45678945'	, '963230125'	, 'Jr. Manzanalas 7894'				, 'JoseFelicianoSanchez@gmail.com'		,'2005-01-01'	,'M'	,'1'				,'Robo Menor'		,'1'			,'150101'),
('Carlos Alberto'		, 'Cama'		, 'Padilla'		, '63254120'	, '963020035'	, 'Av. Sepulveda 56'				, 'CarlosAlbertoPadilla@gmail.com'		,'2005-01-10'	,'M'	,'2'				,'Robo Menor'		,'2'			,'150101'),
('Elizardo Jesús'		, 'Valerio'		, 'Alpaca'		, '63521410'	, '987452145'	, 'Jr. Simón Bolivar 6320'			, 'JesúsValerioAlpaca_7894@gmail.com'	,'2005-01-13'	,'M'	,'3'				,'Robo Menor'		,'3'			,'150101'),
('Juana La'				, 'Cubana'		, 'Del Can'		, '45632012'	, '963254147'	, 'Av. Josefina 7864'				, 'JuanaLaCubana@hotmail.com'			,'2006-01-04'	,'F'	,'4'				,'Robo Menor'		,'4'			,'150101'),
('Maria Fernanda'		, 'Escalante'	, 'Lobo Can'	, '45128975'	, '965874148'	, 'Jr. Los Caceretes 89'			, 'JuanaLaCubana@hotmail.com'			,'2006-01-14'	,'F'	,'5'				,'Robo Menor'		,'5'			,'150101'),
('Eliana Albertina'		, 'Mamani'		, 'Del Campo'	, '63201247'	, '963021201'	, 'Calle Alquatraz 45'				, 'JuanaLaCubana@hotmail.com'			,'2007-12-25'	,'F'	,'6'				,'Robo Menor'		,'1'			,'150101'),
('José Eduardo'			, 'De las'		, 'Cinco casas'	, '63254154'	, '900015488'	, 'Calle Movistar Mz B Lote 15'		, 'JuanaLaCubana@hotmail.com'			,'2008-01-20'	,'M'	,'7'				,'Robo Menor'		,'4'			,'150101')
;
...
SELECT * FROM ubigeo;
SELECT * FROM teen ORDER BY id_teen DESC;
